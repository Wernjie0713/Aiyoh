      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className="text-xl font-bold mb-4">AiThink</h3>
            <p className="mb-4 text-gray-300">
              Learn the best tools and platforms to prepare for your next job.
            </p>
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <ul className="space-y-2">
              ...
              <li><HashLink smooth to="/#about" className="text-gray-300 hover:text-white">About</HashLink></li>
          ...
          <div className="w-full md:w-1/4">
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-gray-300">Location: 123 AI Street, Tech City</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <span className="text-gray-300">Email: AiThink@gmail.com</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <span className="text-gray-300">Phone: +60 1234 56789</span>
              </li>
            </ul>
          </div>
        </div>
